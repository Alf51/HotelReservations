...
insert into reviews(rating, review, date, id_client, id_hotel) VALUES (3, 'С пивом потянет', '2019-04-08', 1, 1);
insert into reviews(rating, review, date, id_client, id_hotel) VALUES (4, 'Норм место', '2019-04-08', 1, 2);
insert into reviews(rating, review, date, id_client, id_hotel) VALUES (5, 'Как греческие боги отдохнул', '2022-04-08', 2, 3);
insert into reviews(rating, review, date, id_client, id_hotel) VALUES (5, 'Шикарный отель', '2022-04-08', 2, 2);
insert into reviews(rating, review, date, id_client, id_hotel) VALUES (3, 'Ночь переспать на тройку понтянет', '2023-07-11', 3, 2);
insert into reviews(rating, review, date, id_client, id_hotel) VALUES (3, 'Не съели и на том спасибо', '2023-07-11', 3, 2);
